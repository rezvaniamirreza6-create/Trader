...
def generate_signal(df):
    ...
    # ============================================================
    # روش استاندارد صنعتی: فاصله SL برابر با 1.5 برابر ATR، و TP با
    # نسبت ریسک‌به‌ریوارد 1:1.5 (یعنی TP فاصله‌اش 1.5 برابر فاصله SL است).
    # این عدد جهت قیمت را پیش‌بینی نمی‌کند؛ فقط فاصله‌ی منطقی و آماری
    # برای خروج از معامله (در صورت تصمیم خود شما به ورود) را مشخص می‌کند.
    ...
    return {
        ...
        "disclaimer": (
            ...
            "تضمینی برای حرکت آینده قیمت نیست. سطح TP/SL بر مبنای نوسان "
            "آماری (ATR) محاسبه شده، نه پیش‌بینی جهت. تصمیم نهایی ورود به "
            "معامله و میزان حجم آن، بر عهده‌ی خود شماست."
        ),
    }
